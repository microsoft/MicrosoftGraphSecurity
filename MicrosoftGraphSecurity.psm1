...
$ExportedCommands = @('Edit-GraphSecurityTiIndicator','Get-GraphSecurityAlert','Get-GraphSecurityAuthToken','Get-GraphSecurityCredential','Get-GraphSecuritySecureScore','Get-GraphSecurityTiIndicator','New-GraphSecurityTiIndicator','Remove-GraphSecurityTiIndicator','Set-GraphSecurityAlert')
